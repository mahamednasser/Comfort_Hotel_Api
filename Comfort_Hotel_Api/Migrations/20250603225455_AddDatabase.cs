    ...
    public partial class AddDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomsRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomsRates_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomsRates_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomsRates_RoomId",
                table: "RoomsRates",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomsRates_UserId",
                table: "RoomsRates",
                column: "UserId");
        }
